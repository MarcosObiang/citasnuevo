...
enum ZonaDenuncia { visorPerfiles, conversacion }
...
class ControladorDenuncias with ChangeNotifier {
  ...
  ControladorDenuncias.visorPerfiles(
      {@required this.idDenunciado,
      @required this.detallesDenuncia,
      @required this.zonaDenuncia,
      @required this.fechaDenuncia,
      @required this.tipologiaDenuncia}) {
  ...
  ControladorDenuncias.conversacion(
      {@required this.idDenunciado,
      @required this.detallesDenuncia,
      @required this.zonaDenuncia,
      @required this.fechaDenuncia,
          ...
          "denuncias": FieldValue.arrayUnion([
            {
              ...
              "horaDenuncia": denuncia.fechaDenuncia,
              "zonaDenuncia":
                  denuncia.zonaDenuncia == ZonaDenuncia.visorPerfiles
                      ? "visorPerfiles"
                      : "conversacion"
            }
          ])
        })
        .then((value) => denunciaEnviada = true)
        .catchError((errr) => denunciaEnviada = false);
}
