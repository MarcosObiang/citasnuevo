          ...
          if (dato.docChanges[a].type == DocumentChangeType.added) {
            for (int i = 0;
                ...
                i++) {
                  ...
                  if( dato.docChanges[a].doc.get("idMensaje")!=null&&dato.docChanges[a].doc.get("Tipo Mensaje")!=null&&dato.docChanges[a].doc.get("respuesta")!=null&&dato.docChanges[a].doc.get("mensajeRespuesta")!=null&&
                  dato.docChanges[a].doc.get("mensajeLeidoRemitente")!=null&&dato.docChanges[a].doc.get("Nombre emisor")!=null&&dato.docChanges[a].doc.get("idConversacion")!=null&&dato.docChanges[a].doc.get("mensajeLeido")!=null&&
                  dato.docChanges[a].doc.get("identificadorUnicoMensaje")!=null&&dato.docChanges[a].doc.get("idEmisor")!=null&&dato.docChanges[a].doc.get("Hora mensaje")!=null&&dato.docChanges[a].doc.get("Mensaje")!=null
                  ){
                    ...
                    if (nuevo.respuesta) {
                      if (nuevo.respuestaMensaje["tipoMensaje"] == "Texto") {
                        nuevo.widgetRespuesta = Container(
                          color: nuevo.respuestaMensaje["idEmisorMensaje"] ==
                          ...
                          child: Column(
                            ...
                            children: [
                              nuevo.respuestaMensaje["idEmisorMensaje"] ==
                                      Usuario.esteUsuario.idUsuario
                                  ? Text("Yo")
                                  : Text(conversaciones.listaDeConversaciones[i]
                                      .ventanaChat.nombre),
                        ...
                        for (int z = 0;
                            z <
                                Conversacion.conversaciones
                                    .listaDeConversaciones.length;
                            z++) {
                          if (Conversacion.conversaciones
                                  .listaDeConversaciones[z].idMensajes ==
                              nuevo.idMensaje) {
                            for (int i = 0;
                                i <
                                    Conversacion
                                        .conversaciones
                                        .listaDeConversaciones[z]
                                        .ventanaChat
                                        .listadeMensajes
                                        .length;
                                i++) {
                              if (nuevo.respuestaMensaje["idMensaje"] ==
                                  Conversacion
                                      .conversaciones
                                      .listaDeConversaciones[z]
                                      .ventanaChat
                                      .listadeMensajes[i]
                                      .identificadorUnicoMensaje) {
                                mensajeRespuestaAudio = Conversacion
                                    .conversaciones
                                    .listaDeConversaciones[z]
                                    .ventanaChat
                                    .listadeMensajes[i];
                                        ...
                                        child: Stack(
                                            ...
                                            children: <Widget>[
                                              ...
                                              SliderTheme(
                                                ...
                                                child: Slider(
                                                  value: mensajeRespuestaAudio
                                                      .posicion,
                                                  max: mensajeRespuestaAudio
                                                      .duracionMensaje
                                                      .toDouble(),
                                                  min: 0,
                                                  onChanged: (val) {
                ...
                ControladorNotificacion.instancia
                    .sumarMensajeNuevoEnNotificacion(dato.docChanges[a].doc);
