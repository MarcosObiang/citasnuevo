...
class _SanctionsScreenState extends State<SanctionsScreen> {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        ElevatedButton(
                                            ...
                                            ElevatedButton(
                                            onPressed: () {
                                              sanctionsPresentation.unlockProfile();
                                            },
                                            child: Text("Desbloquear perfil"))
                                      ],
                                    ),
                                ),
                                 sanctionsPresentation.getUnlockProcessState==UnlockProcessState.inProcess? Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text("Espere",style:GoogleFonts.lato(
  ...
  StreamBuilder<int> sanctionCounter(SanctionsPresentation sanctionsPresentation) {
    return StreamBuilder(
                              initialData: 0,
                              stream: sanctionsPresentation
                                  .sanctionsController
                                  .sanctionsEntity
                                  ?.sanctionStreamController
                                  .stream,
