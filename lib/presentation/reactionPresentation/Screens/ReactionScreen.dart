                  ...
                  children: [
                    AppBar(
                      ...
                      title: Row(
                        ...
                        children: [
                          Text("Reacciones",style: GoogleFonts.lato(
                                fontSize: 70.sp, fontWeight: FontWeight.bold,color:Colors.black ),),
                          Row(
                            children: [
                              reactionPresentation.isPremium == false
                                  ? Text("${reactionPresentation.getCoins}",style: GoogleFonts.lato(
                                fontSize: 65.sp, fontWeight: FontWeight.bold,color:Colors.black ),)
                                  : Icon(LineAwesomeIcons.infinity,color: Colors.black,),
                              Icon(LineAwesomeIcons.gem,color: Colors.black,)
                            ],
                          ),
                        ],
                      ),
